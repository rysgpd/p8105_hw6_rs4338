...
- The distribution is pretty symmetrical with the r^2 values being on
  the higher side.
...
- For the log value, the 95% confidence interval is 1.964811 to
  2.058645.
- This one is less symmetrical. Bootstrapping can help get these
...
- gender of newborn, race of mother, age of mother, previous births

- maternal height, pre-pregnancy weight, weight gain during pregnancy,
  parental ethnicity, smoking

- Citations:

  - Dola SS, Valderrama CE. Exploring parental factors influencing low
    birth weight on the 2022 CDC natality dataset. BMC Med Inform Decis
    Mak. 2024;24(1):367. Published 2024 Nov 30.
    <doi:10.1186/s12911-024-02783-x>
  - Moreira AIM, Sousa PRM, Sarno F. Low birth weight and its associated
    factors. Einstein (Sao Paulo). 2018;16(4):eAO4251. Published 2018
    Nov 8. <doi:10.31744/einstein_journal/2018AO4251>
  - Falcão, IR, Ribeiro-Silva, R, de Almeida, MF, et al. Factors
    associated with low birth weight at term: a population-based linkage
    study of the 100 million Brazilian cohort. BMC Pregnancy Childbirth
    20, 536 (2020). <https://doi.org/10.1186/s12884-020-03226-x>
...
```
    ...
    ##    <chr>                <dbl>     <dbl>     <dbl>     <dbl>
    ##  1 (Intercept)       -704.      191.       -3.70  2.21e-  4
    ##  2 babysexMale         88.5      12.8       6.93  4.96e- 12
    ##  3 mraceBlack        -204.       66.3      -3.08  2.08e-  3
    ##  4 mracePuerto Rican  -20.4      70.6      -0.289 7.73e-  1
    ##  5 mraceWhite          80.0      65.6       1.22  2.22e-  1
    ##  6 momage               0.434     1.80      0.241 8.10e-  1
    ##  7 parity             110.       62.3       1.77  7.63e-  2
    ##  8 mheight             17.0       2.73      6.21  5.98e- 10
    ##  9 ppwt                 3.87      0.356    10.9   3.91e- 27
    ## 10 wtgain               9.58      0.597    16.1   2.06e- 56
    ## 11 smoken             -11.9       0.891   -13.4   4.58e- 40
    ## 12 gaweeks             53.2       2.10     25.4   6.43e-133
...
<img src="p8105_hw6_rs4338_files/figure-gfm/prob3_mymodel-1.png" width="90%" />
